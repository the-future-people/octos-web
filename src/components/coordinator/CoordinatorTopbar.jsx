...
/**
 * Follows BMTopbar closely — same dropdown behaviour, same theme toggle,
 * same keyboard and outside-click handling. A coordinator moving between
 * screens should not have to learn a second set of habits.
 *
 * No sheet pill: a coordinator has no till and no float, and a sheet
 * number would be noise on their screen.
 */
export default function CoordinatorTopbar({ user, onLogout }) {
              ...
              >
                <div className="px-4 py-3 border-b border-[var(--border)]">
                  ...
                  <div className="text-[10px] font-bold text-[var(--text-3)] uppercase tracking-wider mt-1">
                    {user?.branch_detail?.name} · Flow Coordinator
                  </div>
                </div>
                <div className="py-1">
                  <button
